var option_PDFF = {
   ...
   /* BASIC SETTINGS */  
    ...
    zoomRatio: 1.5,
	maxTextureSize: 1600,
	backgroundImage: "pflip/pflip/background.jpg",
    backgroundColor: "#fff",
    controlsPosition: pdfflip.CONTROLSPOSITION.BOTTOM,
    /*allControls: "thumbnail,play,altPrev,pageNumber,altNext,zoomIn,zoomOut,fullScreen,download,sound,share",*/
	allControls: "thumbnail,play,altPrev,pageNumber,altNext,zoomIn,zoomOut,fullScreen,download",
    hideControls: "outline,startPage,endPage",

};

var pdfflipLocation = "/pflip/pflip/";